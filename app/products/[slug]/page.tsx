...
import { absoluteProductImageUrl, getApiProduct, getApiProducts, getApiProductImage, getStartingPrice, isSizeInStock } from '@/lib/api-products'
...
export default async function ProductDetailPage({ params }: Props) {
  ...
  const relatedCollections = collections.filter((collection) => collection.productSlugs.includes(product.slug)).slice(0, 4)
